...
public class LoginMethodForUserFavorite extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_login_method_for_user_favorite, container, false);
        ...
        btnEmail=(Button)view.findViewById(R.id.btnEmailFavorite);
        btnFb=(Button)view.findViewById(R.id.btnFBFavorite);
        loginButton = (LoginButton)view.findViewById(R.id.login_buttonaFavorite);
